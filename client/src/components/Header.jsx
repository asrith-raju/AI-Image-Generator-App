...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type,watch the magic happen.</motion.p>
      ...
      className='flex flex-wrap justify-center mt-16 gap-3'>
        {Array(6).fill('').map((item, index) => (
          ...
          className='rounded hover:scale-105 tranition-all duration-300 cursor-pointer max-sm:w-10' src={index % 2 === 0 ? assets.sample_img_2 : assets.sample_img_1} key={index} alt="" width={70} />
        ))}
      </motion.div>
      <motion.p 
      initial={{opacity:0}}
